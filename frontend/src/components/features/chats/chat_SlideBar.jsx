  ...
  return (
    <div className="flex flex-col h-full p-4 bg-cream-card text-charcoal font-sans-clean">
      <form onSubmit={searchSubmitHandler} className="flex items-center gap-3 mb-4">
        ...
        <button
          type="submit"
          className="p-3 bg-charcoal text-white rounded-xl hover:bg-black transition-all cursor-pointer flex items-center justify-center"
        >
          <i className="fa-solid fa-magnifying-glass text-sm"></i>
        </button>
      </form>
      <div className="border-t border-cream-dark/60 mb-4 animate-expandLine"></div>
