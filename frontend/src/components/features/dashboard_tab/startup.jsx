    ...
    return (
        ...
        >
            <h2 className="text-xl sm:text-2xl font-serif-elegant font-normal text-white mb-6 flex items-center">
                <i className="fa-solid fa-lightbulb text-emerald-400 mr-3 text-sm"></i>
                Startup Spotlight
            </h2>
                ...
                <div className="flex flex-col md:flex-row gap-8">
                    ...
                    <div className="flex-1 flex flex-col justify-between">
                        ...
                        <div className="flex justify-between items-center mt-6">
                            <button
                                onClick={handlePrev}
                                className="px-4 py-2 border border-sand/20 hover:bg-sand/5 text-sand text-xs font-semibold rounded-full transition-colors flex items-center gap-1.5 cursor-pointer"
                            >
