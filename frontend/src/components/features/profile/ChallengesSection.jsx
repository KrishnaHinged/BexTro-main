  ...
  return (
    <div className="space-y-6 font-sans-clean">
      ...
      <div className="flex gap-6 border-b border-cream-dark/60 pb-4">
        <button
          className={`pb-2 text-sm font-semibold px-1 cursor-pointer transition ${
            subTab === "ongoing" 
              ...
              >
                ...
                <div className="flex gap-3 mt-6">
                  <button
                    ...
                    className="bg-charcoal hover:bg-black disabled:bg-charcoal/50 text-white text-xs font-semibold px-5 py-2.5 rounded-xl shadow-sm transition cursor-pointer"
                  >
                    Submit Proof
                  </button>
                  <button
                    ...
                    disabled={actionLoading}
                    className="border border-charcoal/20 hover:bg-charcoal/5 disabled:opacity-50 text-charcoal text-xs font-semibold px-5 py-2.5 rounded-xl transition cursor-pointer"
                  >
                    Drop
                  </button>
                </div>
                ...
                <div className="flex-1">
                  <div className="flex flex-col sm:flex-row justify-between items-start gap-3 mb-3">
                    ...
                    <button
                      ...
                      className="relative w-[110px] h-[30px] rounded-full border border-cream-dark/80 bg-cream flex items-center px-1 transition-all duration-300 active:scale-95 cursor-pointer"
                    >
                      {/* Background fill */}
                      <div
