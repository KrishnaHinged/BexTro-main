...
const MainSlideBar = () => {
  ...
  const menuItems = [
    { id: "dashboard", label: "Dashboard", icon: <FaHome size={22} />, path: "/dashboard" },
    { id: "feed", label: "Feed", icon: <FaGlobe size={22} />, path: "/feed" },
    { id: "communities", label: "Communities", icon: <FaUsers size={22} />, path: "/communities" },
  ];
        ...
        <div className="flex flex-col gap-5 items-center w-full px-2">
          {menuItems.map(({ id, label, icon, path }) => (
            <button
              ...
              className={`transition-all duration-300 rounded-2xl p-3.5 flex items-center justify-center cursor-pointer ${
                active === id
      ...
      <div className="flex flex-col items-center w-full px-3">
        <div className="bg-cream border border-cream-dark/60 rounded-[2.2rem] py-3.5 px-2 flex flex-col items-center gap-4 w-full shadow-sm">
          ...
          <button
            ...
            className={`transition-all duration-200 rounded-xl p-2 cursor-pointer ${
              active === "settings"
