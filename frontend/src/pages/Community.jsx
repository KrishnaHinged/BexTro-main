                ...
                <div className="flex-1 p-6 md:p-10 overflow-y-auto">
                    <div className="flex items-center justify-between mb-8">
                        ...
                        {activeTab === "communities" && (
                            <button 
                                ...
                                className="bg-charcoal hover:bg-black text-white font-semibold py-3 px-6 rounded-full shadow-sm text-sm transition cursor-pointer"
                            >
                                + Create Community
                            </button>
                        )}
                    ...
                    <div className="flex justify-center mb-8">
                        <div className="flex bg-cream-card border border-cream-dark/80 p-1.5 rounded-full w-72 shadow-sm">
                            <button 
                                className={`flex-1 py-2.5 rounded-full text-xs font-semibold transition cursor-pointer ${activeTab === 'communities' ? 'bg-charcoal text-white shadow-sm font-bold' : 'text-charcoal/50 hover:text-charcoal'}`}
                                onClick={() => setActiveTab('communities')}
                            >
                                Communities
                            </button>
                            <button 
                                className={`flex-1 py-2.5 rounded-full text-xs font-semibold transition cursor-pointer ${activeTab === 'chats' ? 'bg-charcoal text-white shadow-sm font-bold' : 'text-charcoal/50 hover:text-charcoal'}`}
                            ...
                            <form onSubmit={handleCreate} className="flex flex-col gap-5">
                                ...
                                <div>
                                    <label className="text-charcoal/80 font-bold text-xs uppercase tracking-wider mb-2 block">
                                        Community Photo <span className="text-charcoal/40 font-normal lowercase">(optional)</span>
                                    </label>
                                    <div className="flex items-center gap-4">
                                        <div className="w-20 h-20 rounded-2xl bg-white border border-cream-dark/80 flex items-center justify-center overflow-hidden shrink-0 shadow-sm">
                                            {photoPreview ? (
                                                ...
                                                <i className="fa-solid fa-camera text-charcoal/20 text-xl"></i>
                                            )}
                                        </div>
                                ...
                                <div className="flex gap-3 mt-4">
                                    <button 
                                        ...
                                        className="flex-1 border border-charcoal/20 hover:bg-charcoal/5 text-charcoal font-semibold py-3.5 rounded-full text-xs transition cursor-pointer"
                                    >
                                        Cancel
                                    </button>
                                    <button 
                                        type="submit" 
                                        className="flex-1 bg-charcoal hover:bg-black text-white font-semibold py-3.5 rounded-full text-xs shadow-md transition cursor-pointer"
                                    >
                                        Create
                                    </button>
                                </div>
        ...
        <div className="bg-cream border-t border-cream-dark/60 pt-4">
            <div className="flex gap-6 border-b border-cream-dark/60 mb-8 pb-4">
                <button 
                    ...
                    className={`pb-2 text-sm font-semibold px-1 transition cursor-pointer ${activeSubTab === 'explore' ? 'text-charcoal border-b-2 border-charcoal font-bold font-serif-elegant' : 'text-charcoal/40 hover:text-charcoal'}`}
                >
                    Explore Public
                </button>
                <button 
                    onClick={() => setActiveSubTab("mine")}
                    className={`pb-2 text-sm font-semibold px-1 transition cursor-pointer ${activeSubTab === 'mine' ? 'text-charcoal border-b-2 border-charcoal font-bold font-serif-elegant' : 'text-charcoal/40 hover:text-charcoal'}`}
                >
                    My Communities
                </button>
            </div>
            ...
            {displayList.length > 0 ? (
                                ...
                                <div className="flex justify-between items-center mt-auto pt-4 border-t border-cream-dark/50">
                                    ...
                                    {activeSubTab === "explore" ? (
                                        <button 
                                            ...
                                            className="bg-charcoal hover:bg-black text-white px-5 py-2.5 rounded-xl font-semibold text-xs shadow-sm transition cursor-pointer"
                                        >
                                            Join
                                        </button>
                                    ) : (
                                        ...
                                        >
                                            Open Chat <i className="fa-solid fa-arrow-right text-[10px]"></i>
                                        </div>
                                    )}
                                </div>
                            </div>
                ...
                <div className="flex flex-col items-center justify-center py-20 bg-cream-card rounded-3xl border border-cream-dark/80 shadow-inner">
                    <div className="text-4xl mb-4 opacity-50"><i className="fa-solid fa-mountain text-charcoal/20"></i></div>
                    ...
                    {activeSubTab === "mine" && (
                        <button 
                            onClick={() => setActiveSubTab("explore")}
                            className="mt-3 text-indigo-600 hover:text-indigo-800 font-bold text-sm underline underline-offset-4 cursor-pointer"
                        >
                            Explore Communities
                        </button>
                    )}
