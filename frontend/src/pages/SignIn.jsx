...
const SignIn = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center min-h-screen bg-cream font-sans-clean px-4 relative overflow-hidden">
      ...
      {/* Small home link */}
      <Link to="/" className="absolute top-8 left-8 text-sm font-semibold text-charcoal/60 hover:text-charcoal transition-colors">
        <i className="fa-solid fa-arrow-left mr-2 text-xs"></i> Back to Home
      </Link>
