    ...
    <div className="font-sans-clean bg-cream text-charcoal min-h-screen selection:bg-purple-200 selection:text-purple-900 overflow-x-hidden">
      ...
      <header className="max-w-7xl mx-auto px-6 py-8 flex items-center justify-between border-b border-cream-dark/40">
        ...
        <div className="flex items-center gap-4">
          <Link href="/signin" className="text-sm font-semibold hover:text-indigo-600 transition-colors">
            Sign In
          </Link>
          <Link
            href="/signup"
      ...
      <section className="max-w-4xl mx-auto text-center px-6 pt-20 pb-16 md:pt-28 md:pb-24">
        ...
        >
          <Link
            href="/signup"
            className="w-full sm:w-auto bg-charcoal hover:bg-black text-white font-medium px-8 py-3.5 rounded-full transition-all duration-300 shadow-lg text-base text-center"
          >
            Create Your Account
          </Link>
          <a
            href="#how"
            className="w-full sm:w-auto border border-charcoal/20 hover:border-charcoal hover:bg-charcoal/5 text-charcoal font-semibold px-8 py-3.5 rounded-full transition-all duration-300 text-base text-center"
          >
            See How it Works
          </a>
        </motion.div>
                ...
                <div className="p-4 rounded-2xl bg-dark-green/60 border border-emerald-800/15 hover:border-emerald-500/20 transition-all opacity-60">
                  <div className="flex items-start justify-between gap-3">
                    <div>
                      ...
                      <p className="text-xs text-sand/60 mt-1">Submit a photo of your sketch.</p>
                    </div>
                    <button className="bg-indigo-600 hover:bg-indigo-700 text-white text-xs px-3 py-1.5 rounded-lg transition-colors font-medium">
                      Submit Proof
                    </button>
