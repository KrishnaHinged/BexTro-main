...
export default function ChallengeAcceptModal({ challengeText, onClose, onSuccess }) {
            ...
            >
                ...
                >
                    ...
                    <input
                        ...
                        className="w-full border border-gray-200 p-2 rounded-lg mb-4 text-center text-charcoal outline-none focus:border-indigo-500"
                    />

                    <div className="flex gap-4">
                        <button onClick={onClose} className="flex-1 border border-gray-200 p-2 rounded-lg hover:bg-gray-50 text-charcoal">
                            Cancel
                        </button>
                        <button
                            onClick={handleAccept}
                            disabled={loading || fetchingAI}
                            className="flex-1 bg-indigo-600 text-white p-2 rounded-lg font-bold hover:bg-indigo-700 disabled:opacity-50"
                        >
