    ...
    return (
        <div className="p-4 border-t border-cream-dark/60 bg-cream-card font-sans-clean">
            <form onSubmit={onSubmitHandler} className="flex gap-3">
                ...
                <button
                    type="submit"
                    className="px-5 py-2.5 bg-charcoal hover:bg-black text-white text-xs font-semibold rounded-xl shadow-sm transition cursor-pointer bg-transparent border-none outline-none"
                >
                    Send
                </button>
            </form>
