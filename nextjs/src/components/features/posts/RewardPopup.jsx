        ...
        <AnimatePresence>
            <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
                ...
                >
                    ...
                    <button 
                        onClick={onClose}
                        className="w-full bg-gray-900 text-white font-black py-4 rounded-2xl shadow-xl hover:bg-gray-800 transition-all transform active:scale-95 border-none outline-none cursor-pointer"
                    >
                        Keep Crushing It!
                    </button>
                </motion.div>
