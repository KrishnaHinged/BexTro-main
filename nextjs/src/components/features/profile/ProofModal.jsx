...
export default function ProofModal({ challenge, onClose, onSuccess }) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/60 flex items-center justify-center p-4">
      <div className="bg-white/90 dark:bg-slate-900 rounded-3xl shadow-2xl max-w-3xl w-full p-6 relative text-charcoal">
        <button
          onClick={onClose}
          className="absolute top-4 right-4 text-gray-700 hover:text-gray-900 border-none bg-transparent outline-none cursor-pointer text-base"
        ...
        <div className="flex gap-2 mb-4">
          {PROOF_TYPES.map((type) => (
            <button
              ...
              className={`px-4 py-2 rounded-lg font-semibold transition border-none outline-none cursor-pointer ${
                proofType === type
          ...
          <div className="flex gap-3">
            {[
              ...
              <button
                ...
                className={`flex-1 flex items-center justify-center gap-2 p-3 rounded-xl border-2 transition-all cursor-pointer bg-white outline-none ${
        ...
        <div className="flex justify-end gap-3">
          <button
            onClick={onClose}
            className="px-4 py-2 border border-gray-300 text-slate-700 rounded-lg hover:bg-gray-100 bg-transparent cursor-pointer"
          >
            Cancel
          </button>
          <button
            ...
            disabled={submitting}
            className="px-5 py-2 rounded-lg bg-indigo-600 text-white hover:bg-indigo-700 disabled:opacity-60 border-none outline-none cursor-pointer"
          >
