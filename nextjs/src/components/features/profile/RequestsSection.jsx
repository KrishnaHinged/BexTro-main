...
export default function RequestsSection({ requests, onAccept, onReject }) {
  return (
            ...
            >
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="bg-charcoal hover:bg-black text-white px-4 py-2 rounded-xl text-xs font-semibold shadow-sm transition cursor-pointer border-none outline-none"
                >
                  Accept
                </button>
                <button
                  onClick={() => onReject(user._id)}
                  className="border border-charcoal/20 hover:bg-charcoal/5 text-charcoal px-4 py-2 rounded-xl text-xs font-semibold transition cursor-pointer bg-transparent"
                >
                  Reject
                </button>
              </div>
