...
export const themes = [
  {
    ...
    activeButtonBg: "bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500 text-white shadow-md",
  ...
  },
  {
    ...
    activeButtonBg: "bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 text-white shadow-lg",
  ...
  },
  {
    ...
    activeButtonBg: "bg-gradient-to-r from-orange-400 to-pink-500 text-white shadow-md",
